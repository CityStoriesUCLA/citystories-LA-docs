...
Creating a *fork* produces your own personal copy of someone else’s code. This allows you to edit your copy and test out your changes before submitting them back to the original code repository. After you test out your changes, you can submit a *Pull Request* to submit your changes up to the original project. Here's an [animation](/citystories-LA-docs/img/github-forking-merging-animation.gif) that walks through the process!
